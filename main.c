    ...
    void admin()
{
    ...
    gotoxy(23,10); printf("User name       : "); scanf("%s",uname);
    ...
    if(strcmp(uname,"FARIHA")==0&&strcmp(pass,"FNH")==0)
        c=1;
    else
    {
        title();
...
do
    ...
    gotoxy(23,15);printf(" Press a number between the range [1-5]  ");
    key=getch();
    ch=key-48;
       ...
       title();
        ...
        fp=fopen("USER.DAT","r");
         ...
         while(fscanf(fp,"%s %s\n",str1,str2)!=EOF)
         {
             ...
             if(strcmp(user.name,str1)==0&&strcmp(user.pin,str2)==0)
                c++;
         }
        ...
        if (c==0)
        {
            ...
            gotoxy(10,10); printf("Cannot find the given combination of USER NAME and PIN CODE!\a");
            getch();
            return;
        }
...
void staff()
{
   int i,ch;
    ...
    do
    {
        ...
        gotoxy(23,12); printf("Pin Code        : "); scanf("%s",user.pin);
        ...
        if (c==0)
        {
            gotoxy(16,10); printf("ERROR USER NAME AND PIN CODE!\a");
            getch();
        }
        else break;
    } while(1);
...
gets(info.gender);
fflush(stdin);
gotoxy(16,7);printf("Enter you date of birth (dd/mm/yyyy): ");
gets(info.dob);
fflush(stdin);
...
title();
    ...
    gotoxy(23,13);printf(" Press a number between the range [1-5]  ");
key4=getche();
    ch4=key4-48;
...
title();
      ...
      char date[13],ex;
      gotoxy(24,6);printf("Enter the date (dd/mm/yyyy):  ");
      scanf("%s",&date);
...
void welcome()
{
    ...
    gotoxy(30,11); printf("Fariha Nur Hasin");
    gotoxy(30,13); printf("Kazi Ramisa Rifa");
